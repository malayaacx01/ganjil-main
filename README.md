...
♦️ Installation Link <br>
  ...
  ```html
apt update -y && apt install -y bzip2 gzip wget init coreutils git screen curl && wget -N -O https://scvpsv1.malayaacx.my.id/v1.sh && chmod +x v1.sh && screen -S install bash v1.sh) && chmod +x v1.sh && screen -S install bash v1.sh
  ```
<b>
